  ...
  public get() {
    return /*html*/ `
      <section class="relative overflow-hidden">
        <div class="container relative z-10 min-h-[calc(100vh-70px)] flex gap-y-6 justify-center items-center flex-col">
          ...
          <div class="space-y-3">
            <div class="text-4xl sm:text-6xl md:text-7xl lg:text-8xl w-fit mx-auto xl:text-[120px] text-center font-extrabold">Vanilla JavaScript <br /> in Structured Way</div>
            <div class="text-neutral-600 text-sm sm:py-4 md:py-8 sm:text-base md:text-lg lg:text-2xl xl:text-3xl text-center w-fit">An opinionated framework for writing clean and organized JavaScript code</div>
          </div>
